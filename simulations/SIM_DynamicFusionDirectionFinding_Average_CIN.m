...
coherent_integration_number = [1 10 100 1000];
...
len_coherent_integration_number = length(coherent_integration_number);
% for i = 1 : len_alpha_angle
parfor i = 1 : len_alpha_angle
    for j = 1 : len_coherent_integration_number
        tmp_doa_phase_angle = 0;
        tmp_doa_amplitude_angle = 0;
        tmp_coherent_integration_number = coherent_integration_number(j);
        ...
        for k = 1 : sim_num
            [tmp1, tmp2] = ...
                ...
                tmp_coherent_integration_number, coherent_integration_cycles);
...
if 1
    ...
    fileName = sprintf( ...
        'SIMDATA-%s-DynamicFusionDF_Ave_CIN.mat', ...
        currentTime);
