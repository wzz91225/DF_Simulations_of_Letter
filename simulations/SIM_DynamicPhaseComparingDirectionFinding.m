...
for i = 1 : length(time_vector)
    ...
    % Single channel antenna receiving signal
...
if is_figure
    ...
    xlabel('time (s)');
    ylabel('amplitude');
    title(['Gaussian noised signal (SNR = ' num2str(snr_value) ' dB) ']);
    xlim([time_vector(1) time_vector(plot_points)]);
    ...
    xlabel('time (s)');
    ylabel('amplitude');
    title('intercepts received signal A');
    ...
    xlabel('time (s)');
    ylabel('amplitude');
    title('intercepts received signal B');
    ...
    % interception of signal A and B spectrum
    figure;
    ...
    xlabel('frequency (Hz)');
    ylabel('amplitude');
    title('intercepts the received signal A spectrum');
    grid on;
    ...
    xlabel('frequency (Hz)');
    ylabel('amplitude');
    title('intercepts the received signal B spectrum');
    grid on;
...
if is_bandpassfilter
    ...
    xlabel('time (s)');
    ylabel('amplitude');
    title('Bandpass filtered signal A');
xlim([tv_sigA(1) tv_sigA(plot_points)]);
    ylim([-2 2]);
    grid on;
    ...
    xlabel('time (s)');
    ylabel('amplitude');
    title('Bandpass filtered signal B');
    xlim([tv_sigB(1) tv_sigB(plot_points)]);
    ylim([-2 2]);
    grid on;
end
    ...
    xlabel('time (s)');
    ylabel('amplitude');
    title('Coherent integration signal A');
    ...
    xlabel('time (s)');
    ylabel('amplitude');
    title('Coherent integration signal B');
